# 🤖 AGENT ROUTING MASTER - FIX TASK DISTRIBUTION
...
- Update budget from v1.0 (€17-50k) to v2.0 Bootstrap (€1-3k)
...
- Update per-site visit cost from €2-5k to €500-1,500
...
- Low: €3-5k, Medium: €5-8k, High: €8-12k
...
- Tiny house: €8-12k, Solar: €3-5k, Well: €1-5k
...
- Change €250-500k to €20-30k Bootstrap goal
- Line 70 fix
...
**Tasks**:
- FIX-023 (Part 1): Replace $ with € in soil_restoration files
- 7 files total
...
**Tasks**:
- FIX-023 (Part 2): Replace $ with € in water_management files
- 7 files total
- Symbol-only replacement (no value changes)
...
**Estimated Total Time**: 8-12 hours (if serial) → 60-90 min (if parallel with 20 agents)

**Priority Distribution**:
- 🔴 HIGH: Agents 1-9, 11 (10 agents)
- 🟡 MEDIUM: Agents 4, 10, 12-17 (8 agents)
- 🟢 LOW: Agents 18-20 (2 agents)
