...
**Total Tasks**: 27
**Status**: 26/27 COMPLETE (2025-11-07)
...
This file contains **only** the audit tasks assigned to the **JANITOR** persona.

**Janitor Role**: Organization, file placement, naming conventions, structure
...
1. **Read persona file**: `_vault_maintenance/personas/janitor.md`
2. **Work through tasks** below sequentially
3. **Document findings** in Result field
4. **Add issues** to `FIX_TASKS_JANITOR.md`
...
**Total Tasks**: 27
**Completed**: 26 (96%)
**Status**: 26/27 COMPLETE

---

## 🔗 RELATED FILES

- **Fix Tasks**: `_vault_maintenance/FIX_TASKS_JANITOR.md`
