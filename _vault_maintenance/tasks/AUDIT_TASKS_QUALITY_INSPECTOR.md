...
**Total Tasks**: 72
**Status**: 70/72 COMPLETE (2025-11-07)
...
This file contains **only** the audit tasks assigned to the **QUALITY INSPECTOR** persona.

**Quality Inspector Role**: Formatting, style, polish, consistency

---

## 🚨 WORKFLOW INSTRUCTIONS

### For Quality Inspector Persona

1. **Read persona file**: `_vault_maintenance/personas/quality_inspector.md`
2. **Work through tasks** below sequentially
3. **Document findings** in Result field
4. **Add issues** to `FIX_TASKS_QUALITY_INSPECTOR.md`
...
**Total Tasks**: 72
**Completed**: 70 (97%)
**Status**: 70/72 COMPLETE

---

## 🔗 RELATED FILES

- **Fix Tasks**: `_vault_maintenance/FIX_TASKS_QUALITY_INSPECTOR.md`
