...
- Control or eradicate existing invasive populations
...
- Conduct thorough site assessment → [[01_Assess_Biodiversity|Assess Biodiversity]]
...
**When to Consider:**
- Mechanical control insufficient
- Large infestations
- Species that resprout aggressively
- As part of integrated approach
...
**Application Methods:**
- Spot treatment (paint on, wipe on)
- Basal bark treatment
- Cut-stump treatment
- Foliar spray (as last resort, carefully targeted)
...
1. Prevention (best)
2. Mechanical removal (preferred for small scales)
3. Biological control (long-term solution if available)
4. Chemical control (last resort, carefully applied)
...
- [[03_Create_Protected_Areas|Previous: Create Protected Areas]]
- [[05_Reintroduce_Lost_Species|Next: Reintroduce Lost Species]]
...
*Next: [[05_Reintroduce_Lost_Species|Reintroduce Lost Species]]*
