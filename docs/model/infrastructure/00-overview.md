...
### Somewhere to live
- **Tiny house or caravan:** quick and cheap to place; limited space. Good to start. Off-grid cabins can be compact and cheap — a 215 sq ft off-grid cabin ([Cabin Devín](/evidence#e1774284779591)) or a ~$9k tiny house with built-in rainwater harvesting ([example](/evidence#e1745869517029)).
...
- **Agrivoltaics:** panels sited so the ground beneath still does useful work, such as grazing or a shaded pond, where the layout genuinely earns its keep ([agrivoltaics that do farm work](/evidence#e1783255090319), *news*).
