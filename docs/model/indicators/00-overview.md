...
The ecological recovery is the real goal, and it resists being flattened into a single number. Measure it to understand whether what you did worked, not to decorate a dashboard. Look at structure and layers, species returning, signs in the soil and water, enough to test your methods (see [method](../method/00-overview.md) and the learning loop). Citizen-science monitoring extends reach at low cost ([citizens monitoring the global biodiversity framework](/evidence#e1742557799411), *study*). A count of stems or a carbon figure on its own tells you little about whether the place is coming alive.
