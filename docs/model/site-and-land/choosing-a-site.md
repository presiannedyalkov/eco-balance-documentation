...
- **A clear reference ecosystem.** You can name what the site should become, which sets the species (see [the method](../method/00-overview.md)).
...
- **Water security** [high]: rainfall, drought risk, and the cost of securing water. Even temperate regions now see dry summers ([Germany plans for drought](/evidence#e1748757905382), *news*). Shaping how water moves across a site helps recharge groundwater.
- **Hazard exposure** [context]: fire, flood, storm, pests. Fire is a serious factor around the Mediterranean ([fire-resilient forests in Iberia](/evidence#e1754888118250), *news*).
...
1. Set your bioregion shortlist (see `parameters/`).
2. Fix a budget ceiling and a workable area range for that bioregion.
3. Search listings, agencies, local contacts, and public-land programs.
4. Score each candidate on the criteria above and keep the comparison written down.
5. Run due diligence on the top one or two before making any offer.
