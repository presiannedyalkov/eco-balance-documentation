...
domain: D7
status: draft
parameters: [funding-landscape]
related: [00-overview, ../economics/revenue]
---
...
- **Trade-offs:** non-dilutive and credible; admin-heavy with modest hit rates. A funding list is a starting point, not proof of fit, and a worked example helps structure applications ([sample grant proposal](/evidence#e1745570948450)).
...
Research site access, education, and similar income are real but later, and belong with [economics/revenue](../economics/revenue.md). They build credibility from year one even when they pay little at first.
