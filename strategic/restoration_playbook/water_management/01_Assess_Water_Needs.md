...
2. **Match Plants to Water:** Plant selection must match available water. Planting water-demanding species in arid conditions without adequate water supply will fail.

3. **Water Budget Required:** A water budget (supply vs. demand) must be calculated. This is essential for sustainable water management.

4. **Climate Data:** Historical precipitation and climate data must be used in assessment. Current year data alone is insufficient.

5. **Documentation:** All water assessment data, calculations, and assumptions must be documented. This is essential for adaptive management.
...
1. **Climate:** Adapt methods to your specific climate (arid, Mediterranean, humid, etc.)

2. **Data Sources:** Use local climate data sources available in your region

3. **Site Conditions:** Factor in your specific site conditions (topography, soil, etc.)

4. **Species Selection:** Match plant water needs to available water

5. **Budget:** Choose assessment pathway based on available resources

6. **Local Resources:** Use local extension services, weather stations, and experts
...
→ [[../../02_Rainwater_Harvesting|Task 2: Rainwater Harvesting]]
