...
1. **Water Quality Matters:** Captured rainwater must be of appropriate quality for intended use. Contaminated water can harm plants, soil, and ecosystem health.

2. **Legal Compliance:** All water capture and storage must comply with local water rights and regulations. This is not optional.

3. **Overflow Management:** All water storage systems must have overflow management. Uncontrolled overflow can cause erosion and flooding.

4. **Maintenance Required:** Water harvesting systems require maintenance to function effectively. Neglected systems fail and waste resources.

5. **Documentation:** All water harvesting systems, capacities, and performance must be documented. This is essential for optimization and adaptive management.
...
5. Install distribution system
6. Test all components
7. Monitor first few rain events

**For passive systems:**
1. Mark contours
2. Excavate swales/berms
3. Shape basins
4. Plant vegetation
5. Test during rain
6. Adjust as needed
...
1. **Climate:** Adapt systems to your specific climate and rainfall patterns

2. **Topography:** Use your site's topography to your advantage

3. **Budget:** Choose system complexity based on available resources

4. **Legal Context:** Research and comply with local water regulations
...
→ [[../../03_Build_Water_Storage_Structures|Task 3: Build Water Storage Structures]]
