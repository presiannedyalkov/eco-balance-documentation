...
**Current Status**: Vision clear and committed. Execution pathways flexible and under active exploration. Key decisions (location, funding pathway, legal structure) deferred until opportunities clarify (Month 4-6 decision timeline). → See [[_process/documentation/ROADMAP|Project Roadmap]] for current blockers and status.
...
→ See [[strategic/30_Business_Model|Business Model]]

### 🤝 Community-Centric
**Will include** local employment, education, and traditional knowledge integration
→ See [[strategic/60_Marketing_Communications_Strategy|Community Engagement]]
...
→ See [[strategic/40_Expansion_Growth_Strategy|Growth Roadmap]] and [[strategic/43_Operations_Action_Plan|Operations]]
...
→ Details in [[strategic/42_Adaptive_Timeline|Adaptive Timeline]]
...
→ Details in [[strategic/40_Expansion_Growth_Strategy|Growth Strategy]]
...
→ Detailed strategy in [[strategic/32_Funding_Strategy|Funding Strategy]]
...
→ Financial details in [[strategic/30_Business_Model|Business Model]] and [[strategic/31_Financial_Projections|Financial Projections]]
...
→ Full analysis in [[strategic/44_Site_Selection_Land_Acquisition|Site Selection]]
...
→ Details in [[strategic/10_Organizational_Structure|Organizational Structure]] and [[strategic/13_Legal_Framework|Legal Framework]]
...
→ Context in [[strategic/02_Project_Vision|Project Vision & Context]]
...
→ Full timeline in [[strategic/42_Adaptive_Timeline|Adaptive Timeline]]
...
**Strategy & Vision**:
- [[strategic/02_Project_Vision|Project Vision & Context]] - Geographic flexibility and long-term vision
- [[strategic/03_Success_Factors|Success Factors]] - Critical success factors and assumptions
- [[strategic/04_Current_Status_Assessment|Current Status Assessment]] - Current state and exploration status
...
- [[strategic/restoration_playbook/README|Implementation Tasks]] - 44 detailed step-by-step field guides

**Organization & Legal**:
- [[strategic/10_Organizational_Structure|Organizational Structure]] - Team structure and roles
- [[strategic/11_Governance|Governance Framework]] - Decision-making and accountability
- [[strategic/12_Team_Roles|Team Roles]] - Role definitions and responsibilities
- [[strategic/13_Legal_Framework|Legal Framework]] - Legal structure options and compliance
...
- [[strategic/32_Funding_Strategy|Funding Strategy]] - Funding pathways and strategies
