...
- Form legal entity (e.V., Associação, or equivalent)
...
**Flexibility Notes**:
- If funding comes faster → Accelerate to Months 10-12
- If land search takes longer → Extend Phase 1 to Month 15
- If crowdfunding exceeds expectations → Upgrade infrastructure plans
- If grants delayed → Bootstrap with lean approach
...
### 1. Funding Speed
- **Secured in 3 months** (grant awarded, crowdfunding succeeds early) → Fast Track possible
- **Secured in 6 months** (crowdfunding campaign completes) → Gradual Build likely
- **Secured in 12+ months** (slow grant cycles, bootstrap) → Slow & Steady

### 2. Founder Work Availability
- **Can go full-time** → Fast Track (6-9 months)
- **Part-time 15-25 hr/week** → Gradual Build (12-18 months)
- **Very part-time 10-15 hr/week** → Slow & Steady (24-36 months)

### 3. Location Decision Clarity
- **Decided Month 1-2** (clear opportunity) → Enables faster execution
- **Decided Month 4-6** (after exploration) → Gradual Build timeline
- **Decided Month 6-12** (multiple factors, indecision) → Extends timeline

### 4. Land Availability
- **Perfect land found Month 1-3** → Can accelerate
- **Search takes 4-8 months** → Normal pace
- **Search takes 8-12+ months** → Extends timeline

### 5. Regulatory/Legal Speed
- **e.V. or Associação** (4-8 weeks) → Minimal delay
- **gGmbH** (3-6 months) → Adds timeline
- **Informal Year 1** (no entity) → Fastest but limited capability
...
**Confirmed Decisions**:
- [x] Vision: Restore 1ha ecosystem as proof of concept
- [x] Work model: Part-time Year 1-2 (15-25 hr/week, keep jobs)
- [x] Core team: 1-2 founders
- [x] Geographic scope: Europe (EU citizenship/access)
- [x] Baseline timeline: 12-18 months (Option B)

**Actively Exploring** (No commitment yet):
- [ ] Funding pathway: Crowdfunding vs grants vs bootstrap vs partnership → Explore all until Month 4-6
- [ ] Location: Germany vs Portugal vs other EU → Decide when opportunity emerges or by Month 6
- [ ] Legal structure: e.V. vs Associação vs other → Decide when location clear
- [ ] Land: Buy vs lease vs borrow → Decide when funding and location clear
- [ ] Infrastructure level: Minimal vs Basic vs Full → Decide based on budget secured
...
### Triggers to Accelerate (B → A: Gradual to Fast Track)
...
### Triggers to Decelerate (B → C: Gradual to Slow & Steady)
...
|-------|----------|------|-------|
| Legal & planning | 1-2 months | €1-3k | Fast entity formation |
| Land acquisition | 1-2 months | €8-15k | Purchase or substantial lease |
| Infrastructure | 2-3 months | €8-15k | Full setup, quality equipment |
| Launch & planting | 1-2 months | €3-5k | Plants, events, initial ops |
...
| Phase | Duration | Cost | Notes |
|-------|----------|------|-------|
| Preparation | 6 months | €2-4k | Campaign, legal, travel |
| Land acquisition | 3-6 months | €8-18k | Purchase or lease |
| Infrastructure | 3-6 months | €6-12k | Basic to moderate setup |
| Launch & planting | 3-6 months | €2-6k | Plants, community, operations |
...
| Phase | Duration | Cost | Notes |
|-------|----------|------|-------|
| Year 1 planning | 12 months | €1-2k | Learning, saving, minimal expense |
| Year 2 land & minimal setup | 12 months | €6-10k | Lease + basic infrastructure |
| Year 3 operations & upgrade | 12 months | €5-10k | Plants, upgrades, expansion |
...
**Planning & Strategy**:
- [[strategic/30_Business_Model|Funding Pathways]] - Multiple funding options detailed
- [[strategic/32_Funding_Strategy|Fundraising Playbook]] - Crowdfunding, grants, and more
- [[strategic/44_Site_Selection_Land_Acquisition|Finding Land]] - Geographic flexibility and site options
- [[strategic/10_Organizational_Structure|Legal Structure Options]] - e.V., Associação, gGmbH, and more

**Implementation**:
- [[strategic/43_Operations_Action_Plan|Operations Plan]] - What happens after you launch
- [[strategic/20_Restoration_Methodology|Restoration Methods]] - Temperate vs Mediterranean approaches
- [[strategic/21_Technology_Integration|Technology Options]] - Solar, water, monitoring equipment

**Risk & Evaluation**:
- [[strategic/50_Risk_Assessment|Risk Management]] - Adaptive risk strategies
- [[strategic/51_Key_Performance_Indicators|Measuring Success]] - How to track progress
- [[strategic/40_Expansion_Growth_Strategy|Scaling Options]] - What comes after Year 1
