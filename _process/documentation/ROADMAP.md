...
### ✅ Completed: Documentation Phase (v1.0.0 → v2.0.0)

**v1.0.0** (October 2025)
- Initial strategic documentation created
- Large-scale aspirational model (10-30 hectares, €500k-2M)
- Comprehensive implementation guides

**v2.0.0 - Bootstrap Model** (November 6, 2025)
- **MAJOR TRANSFORMATION**: Shifted from aspirational to immediately executable
- Bootstrap approach: 1 hectare pilot, €20-30k Year 1, 1-2 founders
...
### Phase 1: Bootstrap Launch (Current) - Year 0-1
...
- [ ] Launch crowdfunding campaign (€10-12k target)
- [ ] Secure 1 hectare site (€10-30k)
...
→ Detailed plan: [[strategic/42_Adaptive_Timeline|Next 90 Days]]

---

### Phase 2: Proof of Concept - Year 1-2
...
- [ ] Secure expansion funding (€250-500k)
- [ ] Identify 5-10 hectare expansion site
- [ ] Build team to 3-4 people
- [ ] Establish partnerships with research institutions

**Budget**: €50-100k Year 2
- Grants: €30-60k
- Social enterprise revenue: €10-20k
- Continued crowdfunding: €10-20k
...
### Phase 3: Public Platform & Community Engagement - Year 1-2
...
5. **Moderation & Governance**
   - 3-tier moderation: AI pre-filter → Community review → Core team decision
...
**Budget**:
- Development: €60,000 - €120,000 (one-time)
- Operations: €910 - €3,110/month
- Scales with usage
...
→ Detailed plan: [[_process/planning/PUBLIC_PLATFORM_PLAN|Public Platform Plan]]

---

### Phase 4: Scaling Operations - Year 2-5
...
- [ ] Generate €50-100k annual revenue from social enterprise
- [ ] Secure major grants (€100k+)
...
**Budget**: €250-500k Years 2-3, then €150-250k/year ongoing
...
### Phase 5: Replication & Network - Year 5-10
...
### Must-Haves for Each Phase

**Phase 1 (Bootstrap)**:
✓ Secured land with restoration potential
✓ Minimum €20k funding
✓ 1-2 committed founders
✓ Community of early supporters
✓ Documented baseline data

**Phase 2 (Proof of Concept)**:
✓ Measurable ecological improvements
✓ Published results and case study
✓ Expansion funding secured
✓ Growing team (3-4 people)
✓ Research partnerships

**Phase 3 (Public Platform)**:
✓ Functional web platform
✓ Active community engagement (500+ users)
✓ AI systems working reliably
✓ Quality feedback incorporated
✓ Sustainable operations budget

**Phase 4 (Scaling)**:
✓ 5-10 hectares restored
✓ Self-sustaining operations (50%+ revenue)
...
✓ Demonstrated regional impact
✓ Policy influence
✓ Financial sustainability
✓ Global model recognition
...
Year 0-1:  Phase 1 (Bootstrap Launch) + Phase 3 (Platform Development)
           ├─ Resolve critical issues (Month 0)
           ├─ Crowdfunding & land search (Months 1-3)
           ├─ Site occupation & setup (Months 4-6)
           ├─ Initial restoration (Months 6-12)
           └─ Platform launch (Months 3-9, then ongoing)

Year 1-2:  Phase 2 (Proof of Concept) + Platform Operations
           ├─ Full restoration cycle (Year 1)
           ├─ Data collection & analysis (Year 1-2)
           ├─ Case study publication (Year 2)
           ├─ Expansion fundraising (Year 2)
           └─ Community growth (500-2,000 users)

Year 2-5:  Phase 4 (Scaling Operations)
           ├─ Expand to 5-10 hectares
           ├─ Build team to 5-8 staff
           ├─ Establish legal structure
           ├─ Revenue generation (€50-100k/year)
           └─ Replication toolkit development

Year 5-10: Phase 5 (Replication & Network)
           ├─ 10+ sites operational
...
**Phase 2 → Phase 4**:
- Must secure €250-500k expansion funding
...
- Requires development resources (€60-120k + ongoing)
...
### Immediate (This Week)
1. **Resolve critical blocking issues** (separate thread - in progress)
2. **Review and approve this roadmap**
3. **Prioritize**: Bootstrap launch vs. Platform development vs. Parallel approach

### Short-Term (Next Month)
1. **If Bootstrap Launch prioritized**:
   - Begin crowdfunding campaign design
   - Start land search
   - Build email list of supporters

2. **If Platform prioritized**:
...
**Current State**:
- [[strategic/00_Eco_Balance_Hub|Project Hub]] - Main navigation
- [[_versions/README|Version Information]] - Version tracking
- [[_process/documentation/CHANGELOG|Changelog]] - Complete version history
- [[_process/documentation/FEATURE_WISHLIST|Feature Wishlist]] - Desired features and enhancements

**Phase 1 (Bootstrap Launch)**:
- [[strategic/42_Adaptive_Timeline|Next 90 Days]] - Detailed action plan
- [[strategic/32_Funding_Strategy|Funding Strategy]] - Crowdfunding and fundraising
- [[strategic/44_Site_Selection_Land_Acquisition|Site Selection]] - Finding land
- [[strategic/43_Operations_Action_Plan|Operations Plan]] - Site setup and management

**Phase 3 (Public Platform)**:
- [[_process/planning/PUBLIC_PLATFORM_PLAN|Public Platform Plan]] - Complete technical specification
- [[ai_skills/README|AI Skills Framework]] - Role definitions and templates

**General Strategy**:
- [[strategic/01_Executive_Summary|Executive Summary]] - Vision and mission
- [[strategic/02_Project_Vision|Project Vision]] - Global context and approach
- [[strategic/40_Expansion_Growth_Strategy|Expansion Strategy]] - 10-year scaling plan
