...
│
├── 📁 strategic/                 ← Strategic documentation (source of truth)
│   ├── 📄 01-70_*.md            ← 24 strategic documents
│   │   ├── 01-04: Core Strategy
│   │   ├── 10-13: Organization
│   │   ├── 20-22: Technical
│   │   ├── 30-32: Financial
...
│   │   └── 70: Reference
│   │
│   └── 📁 restoration_playbook/  ← Restoration playbook template
│       ├── 📄 README.md         (1 file)
...
│
├── 📁 _process/documentation/    ← Meta/documentation files
...
**Quick Access:**
- Vision/Mission → **strategic/02_Project_Vision.md**
- Current Status → **strategic/04_Current_Status_Assessment.md**
- Legal Structure → **strategic/10_Organizational_Structure.md**
- Technical Approach → **strategic/20_Restoration_Methodology.md**
- Money → **strategic/30_Business_Model.md** & **strategic/32_Funding_Strategy.md**
- Next Steps → **strategic/42_Adaptive_Timeline.md**
- Risks → **strategic/50_Risk_Assessment.md**
...
**Start exploring from the Hub: [[strategic/00_Eco_Balance_Hub|Eco Balance Hub]]**
...
[[strategic/00_Eco_Balance_Hub|← Back to Hub]] | [[_process/documentation/CHANGELOG|View Changelog]]
