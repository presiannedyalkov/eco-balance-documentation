...
│
├── 📄 01-70_*.md                 ← 22 strategic documents
│   ├── 01-04: Core Strategy
│   ├── 10-13: Organization
│   ├── 20-22: Technical
│   ├── 30-32: Financial
│   ├── 40-44: Implementation
│   ├── 50-51: Risk & KPIs
│   ├── 60: Marketing
│   └── 70: Reference
│
├── 📁 implementation_tasks/      ← 44 execution guides
...
│
├── 📁 _versions/                ← Version artifacts & reports
│   ├── README.md
│   └── 📁 v1.0.0/
│       ├── RELEASE_NOTES.md
│       └── 📁 reports/
...
2. Read **01_Executive_Summary.md** (5 minutes)
...
1. **02_Project_Vision.md** - Why we exist
2. **20_Restoration_Methodology.md** - How we work
3. **04_Current_Status_Assessment.md** - Where we are
4. **42_Next_Steps_90_Days.md** - What's next

**Time:** 45-60 minutes for comprehensive understanding

### Path 3: "I need to DO something"
1. **42_Next_Steps_90_Days.md** - Immediate actions
2. **implementation_tasks/README.md** - All task guides
...
1. **01_Executive_Summary.md** - Core pitch
2. **30_Business_Model.md** - Sustainability
3. **20_Restoration_Methodology.md** - Credibility
4. **51_Key_Performance_Indicators.md** - Metrics

**Time:** 30 minutes to gather key points

### Path 5: "I'm joining the team"
1. **00_Eco_Balance_Hub.md** - Overview
2. **12_Team_Roles.md** - Your potential role
3. **43_Operations_Action_Plan.md** - How we operate
4. **04_Current_Status_Assessment.md** - Current state
...
### Strategic Planning
**Location:** Root directory, files 00-70

**Quick Access:**
- Vision/Mission → **02_Project_Vision.md**
- Current Status → **04_Current_Status_Assessment.md**
- Legal Structure → **10_Organizational_Structure.md**
- Technical Approach → **20_Restoration_Methodology.md**
- Money → **30_Business_Model.md** & **32_Funding_Strategy.md**
- Next Steps → **42_Next_Steps_90_Days.md**
- Risks → **50_Risk_Assessment.md**

### Implementation Guides
**Location:** implementation_tasks/ directory
...
- v1.0.0 details → **_versions/v1.0.0/RELEASE_NOTES.md**
...
- Integration process → **_process/integration/**
- Migration history → **_process/migration/**
- Session summaries → **_process/sessions/**
- Refactoring notes → **_process/refactoring/**
...
### The Version Flow
```
Edit Content → Update CHANGELOG → Bump VERSION → Create Artifacts
```
...
- ✅ How to use implementation tasks
- ✅ How to contribute/update docs

**Start exploring from the Hub: [[00_Eco_Balance_Hub|Eco Balance Hub]]**
